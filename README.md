...
- ICLR 2026: [poster page](https://iclr.cc/virtual/2026/poster/10009904)
...
[TTGOS (Two-Topos Grounding OS)](https://github.com/hironao-nakamura/two-topos-grounding-os) is a safety framework for autonomous AI agents by [Hironao Nakamura](https://hironao-nakamura.github.io/) (independent researcher). It provides model-agnostic safety guarantees, demonstrated across multiple benchmarks.
